...
//
// Taken from Robert Morris GitHub repository: https//github.com/rtmrtmrtmrtm/ft8mon
...
class FT4FT8Utilities {
 ...
 public:
  ...
  uint32_t static ldpcDecode(std::vector<bool> const & pIn174, uint32_t iterations, std::vector<bool> * pOut174);
