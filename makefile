...
FNLFSRC = WSPRUtilities.cc WSPRUtilities.h WindowSample.cc WindowSample.h WSPRWindow.cc WSPRWindow.h Fano.cc Fano.h FindNLargestF.cc FindNLargestF.h WSPRSymbols.cc WSPRSymbols.h WSPRPass1.cc WSPRPass1.h SpotCandidate.cc SpotCandidate.h
AGCSRC = AGC.cc AGC.h
...
FNLFOBJ = WSPRUtilities.o WindowSample.o WSPRWindow.o Fano.o FindNLargestF.o WSPRSymbols.o WSPRPass1.o SpotCandidate.o
AGCOBJ = AGC.o
...
$(EXECUTABLE): $(SOURCES) $(OBJECTS) $(FIRFILTOBJ) $(RTLTCPOBJ) $(MODOBJ) $(FFTOBJ) $(AGCOBJ) $(FNLFOBJ) $(BASICOBJ)
	$(CC) $(OBJECTS) $(FIRFILTOBJ) $(RTLTCPOBJ) $(MODOBJ) $(FFTOBJ) $(AGCOBJ) $(FNLFOBJ) $(BASICOBJ) -o dspp $(LDFLAGS)
